...
if __name__ == '__main__':
    ...
    r = Road(road_name='Dave Cres', road_geom=WKTSpatialElement('SRID=-1;LINESTRING(198231 263418,198213 268322)', -1))
    session.add(r)
    
    # pre flush, the WKTSpatialElement represents the string we sent.
    assert str(r.road_geom) == 'SRID=-1;LINESTRING(198231 263418,198213 268322)'
