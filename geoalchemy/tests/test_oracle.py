...
engine = create_engine('oracle://system:system@172.16.101.131:11432/gis', echo=True)
...
#        eq_(session.scalar(oracle_functions.svg('POINT(-88.9055734203822 43.0048567324841)')), u'cx="-88.905573420382197" cy="-43.0048567324841"')
